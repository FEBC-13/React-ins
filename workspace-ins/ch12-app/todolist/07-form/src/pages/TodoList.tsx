...
function TodoList() {
  ...
  const itemList = optimisticData?.items.map(item => <TodoListItem key={ item._id } item={ item } handleDelete={ handleDelete } handleToggleImportant={ handleToggleImportant } />);
