  ...
  return (
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <Button type="button" color="blue" bg="gray">회원가입</Button>
        <Button type="button" color="red" bg="yellow">로그인</Button>
        <Button type="button" color="white" bg="green">아이디 찾기</Button>
      </form>
    </div>
  );
};
