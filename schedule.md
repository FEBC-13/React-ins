...
부정적인 반응들 끌어내시며
충분히 비난하는 흐름을 막을 수 있었을텐데 일부러 방치한 것이니, 정말 실망스러울 것 같습니다

저는 그동안 외부 잡음이 줌의 필터링 기능으로 차단이 되고 있다고 생각했었는데 그렇지 않다는걸 알게 되었고 덕분에 줌 설정에서 차단 수준을 더 높이는게 가능하단걸 확인하고 설정을 바꿨습니다.
그 설문을 보고 제가 든 생각은 사람에 따라서 충분이 불편할 수 있다고 생각을 했기 때문에 그게 이상하거나 
제가 오늘 수업시간에 그런 얘기를 꺼낸 이유는 "부정적인 반응을 끌어내기 위해서"가 아니라 사람에 따라서 충분이 그럴수 있으므로 그동안 차단이 안되고 있다는걸 몰랐고 설정을 통해서 이제는 들리지 않을 것이다. 
